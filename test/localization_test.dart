...
final List<String Function(AppStrings)> _allGetters = [
  ...
  (s) => s.getCredentialRequest,
  (s) => s.yourDigitalIdTitle,
  (s) => s.yourDigitalIdSubtitle,
  (s) => s.credential,
  (s) => s.issuer,
  (s) => s.whatYouGet,
  (s) => s.credentialContains,
  (s) => s.whatYouGetHint,
  (s) => s.issuerVerified,
  ...
  (s) => s.credentialIssuedSubtitle,
  (s) => s.requestPendingTitle,
  (s) => s.requestPendingSubtitle,
  (s) => s.statusLabel,
  (s) => s.statusUnderReview,
  (s) => s.requestReference,
  (s) => s.requestSubmittedOn,
  (s) => s.requestExpectedBy,
  (s) => s.requestInProgress,
  (s) => s.viewStatus,
  (s) => s.simulateApproval,
  (s) => s.scanTitle,
  (s) => s.scanSubtitle,
  (s) => s.havingTrouble,
  ...
  (s) => s.issuedBy,
  (s) => s.credentialMatches,
  (s) => s.credentialMissing,
